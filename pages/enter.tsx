...
//         ssr: false,
//         suspense: true,
//         //loading: () => <span>Loading a big component 4u</span>,
//     }
// );
...
export default function Enter() {
    ...
    const [enter, { loading, data, error }] =
        useMutation<MutatuionResult>("/api/users/enter");

    const [
        confirmToken,
        { loading: tokenLoading, data: tokenData, error: tokenError },
    ] = useMutation<MutatuionResult>("/api/users/confirm");
